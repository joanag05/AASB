...
class Test_SEQS(unittest.TestCase):
    ...
    def test_codon_to_amino(self):
        """Testar a função codon_to_amino
        """
    ...
    def test_get_orfs(self):
        ...
        self.assertEqual(SEQS('agtagaatgattg').get_orfs(),['AGTAGAATGATTG','GTAGAATGATTG','TAGAATGATTG','caatcattctact','aatcattctact','atcattctact'])
        self.assertEqual(SEQS('JACGATAGCHKSS').get_prots(),'NOT DNA')
        self.assertEqual(SEQS('MIRWRI').get_prots(),'NOT DNA')

    def test_get_all_prots(self):
        """Testar a função get_all_prots
        """
        self.assertEqual(SEQS("ATGATACGATGGCGTATAA").get_all_prots(),['MIRWRI', 'MAY'])
        self.assertEqual(SEQS("atgatacgatggcgtataa").get_all_prots(),['MIRWRI', 'MAY'])
        self.assertEqual(SEQS('JACGATAGCHKSS').get_prots(),'NOT DNA')
        self.assertEqual(SEQS('MIRWRI').get_prots(),'NOT DNA')
